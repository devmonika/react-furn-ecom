...
const Test2 = () => {
	return (
		<>
			  ...
			  <blockquote
                class="flex h-full flex-col justify-between bg-[#C2DFDC] p-12"
              >
                <div>
                  <div class="flex gap-0.5 text-secondary justify-center">
                    <svg
                      class="h-5 w-5"
                      fill="currentColor"
                      viewBox="0 0 20 20"
                  ...
                  <div class="mt-4">
                    <p class="text-2xl font-bold text-[#4E5554] sm:text-3xl">
                      Stayin' Alive
                    </p>
